...
function Table({ className, ...props }: React.ComponentProps<"table">) {
  return (
    // Remove the wrapper div or make sure it doesn't clip the sticky header
    <table
      data-slot="table"
      className={cn(
...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn(
        "sticky top-0 z-10", // Position the container
        "[&_tr]:hover:bg-transparent",
        "[&_tr]:border-b-0",
        // IMPORTANT: Apply the background and sticky behavior to the child TH cells
